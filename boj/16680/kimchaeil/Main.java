...
b = 10-n이라는 사실을 알아낼 때
b가 양수라는 조건과 n이 9 이하라는 조건이 없어도 상관 없는 유도 방식이라 그런것 같다고 생각을 했습니다.
그리고 a의 계수가 10의 배수이기만 하면 된다는 것을 생각했습니다.
...
floor(99n/100)의 결과인 a가 꼭 2자리일 필요는 없다고 생각했습니다.
...
임의의 값 n에 대해 n*(10^9 -1) = n*(999999999)의 각 자리수의 합은 홀수인 안수빈수입니다.
